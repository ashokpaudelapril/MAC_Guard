# Canvas AI — Project Instructions for AI Assistants

Paste this file at the start of any AI session to give the assistant full project context.
...
- Check that the fix did not break anything adjacent
- If you wrote a test for this route before, re-run it

### Step 5 — Document it
- Add an entry to `docs/DEVLOG.md` describing the bug, root cause, and fix
- If this bug reveals a pattern, note it in DEVLOG so we don't repeat it
